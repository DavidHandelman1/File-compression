Collaborated with Professor Slott and a group of CSUSM students to implement a file compression and decompression system. Uses python GUI to prompt user for .txt file to be compressed,
